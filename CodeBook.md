...
| Variable Name        | Variable Type | Variable Width | Values                                                                     | Description                                                                                 |
|----------------------|---------------|----------------|----------------------------------------------------------------------------|---------------------------------------------------------------------------------------------|
| activity             | factor        | 18             | {WALKING, WALKING_UPSTAIRS, WALKING_DOWNSTAIRS, SITTING, STANDING, LAYING} | performed activity                                                                          |
| subject              | factor        | 2              | \[1;30]                                                                     | subject performing activity                                                                 |
| SIGNAL-mean()(-AXIS) | numeric       | 7              | ]-1;1\[                                                                     | average of the mean of SIGNAL (possibly AXIS) grouped by activity and subject               |
| SIGNAL-std()(-AXIS)  | numeric       | 7              | ]-1;1\[                                                                     | average of the standard deviation of SIGNAL (possibly AXIS) grouped by activity and subject |
